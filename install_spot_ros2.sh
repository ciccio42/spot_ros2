...
while true; do
 ...
 apt-get update &&  apt-get install -y python3-rosdep python3-pip wget
...
# Install the dist-utils
 ...
 pip3 install --no-cache-dir --force-reinstall -v "setuptools==59.6.0"
...
yes |  /tmp/ros-humble-bosdyn_msgs_${MSG_VERSION}-jammy_${ARCH}.run  --nox11
